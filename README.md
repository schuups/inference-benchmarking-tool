...
3. **Agentic-workload approximation.** Agentic workloads are modelled as multi-turn sessions with bursty fan-out — enough to derive supportable-user-count from λ + an SLO; precise per-tool modelling deferred (see `TODOs.md`).
