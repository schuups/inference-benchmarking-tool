...
Resolves the tokenizer per §10.6 (the target model's, unless
...
def _resolve_tokenizer_id(cfg, override: str | None) -> str:
    ...
    if len(models) > 1:
        raise SystemExit(
            ...
            "dataset_config.tokenizer_id explicitly (§10.6 — the target tokenizer "
...
def main() -> int:
    ...
    try:
        ...
        print(f"ABORT (§10.1 source failure): {exc}")
        return 1
